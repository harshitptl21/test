        ...
        <form class="form-horizontal" id="register"  method="post" action="register_post.php">
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label class="radio"><input type="radio" value="1" name="register-gender" id="register-male">Male</label>
                <label class="radio"><input type="radio" value="0" name="register-gender" id="register-female">Female</label>
              </div>
            </div>
